 ...
 * returns the longest name of among all datasets based on {@link LongestString}
 * 
 * @author Hendrik Roeder
 * 
 */
public class NameFuserLongest extends AttributeValueFuser<String, Athlete, Attribute> {

	public NameFuserLongest() {
		super(new LongestString<Athlete, Attribute>());
	}
