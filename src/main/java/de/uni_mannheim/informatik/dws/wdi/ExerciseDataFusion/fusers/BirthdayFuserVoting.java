 ...
 * returns the birthday of an athlete based on {@link Voting}
 * 
 * @author Hendrik Roeder
 * 
 */
public class BirthdayFuserVoting extends AttributeValueFuser<LocalDateTime, Athlete, Attribute> {

	public BirthdayFuserVoting() {
		super(new Voting<LocalDateTime, Athlete, Attribute>());
	}
