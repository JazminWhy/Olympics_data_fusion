 ...
 * uses the {@link ClusteredVote} function for height values to account for unit
 * conversion rounding or different number of decimal places.
 * 
 * @author Tido Felix Marschall
 * 
 */
public class HeightFuserClusteredVote extends AttributeValueFuser<Double, Athlete, Attribute> {

	public HeightFuserClusteredVote() {
		super(new ClusteredVote<Double, Athlete, Attribute>(new AbsoluteDifferenceSimilarity(0.021), 0.00001));
	}
