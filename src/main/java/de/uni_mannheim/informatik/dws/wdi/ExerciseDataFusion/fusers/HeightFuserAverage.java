 ...
 * calculates the {@link Average} for all existing height values
 * 
 * @author Hendrik Roeder
 * 
 */
public class HeightFuserAverage extends AttributeValueFuser<Double, Athlete, Attribute> {

	public HeightFuserAverage() {
		super(new Average<Athlete, Attribute>());
	}
