 ...
 * calculates the {@link MedianCustom} value of all weights, which also works if
 * there is only a single value.
 * 
 * @author Hendrik Roeder
 * 
 */
public class WeightFuserMedian extends AttributeValueFuser<Double, Athlete, Attribute> {

	public WeightFuserMedian() {
		super(new MedianCustom<Athlete, Attribute>());
	}
