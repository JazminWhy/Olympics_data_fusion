 ...
 */
public class ClusteredVoteCustom<ValueType, RecordType extends Matchable & Fusible<SchemaElementType>, SchemaElementType extends Matchable> extends ConflictResolutionFunction<ValueType, RecordType, SchemaElementType> {

	private SimilarityMeasure<ValueType> similarityMeasure;
	private double threshold;
	
	public ClusteredVoteCustom(SimilarityMeasure<ValueType> similarityMeasure, double threshold) {
	...
	public FusedValue<ValueType, RecordType, SchemaElementType> resolveConflict(
		...
		for(Collection<FusibleValue<ValueType, RecordType, SchemaElementType>> clu : clusters.keySet()) {
			...
			System.out.println(centre.getValue());
