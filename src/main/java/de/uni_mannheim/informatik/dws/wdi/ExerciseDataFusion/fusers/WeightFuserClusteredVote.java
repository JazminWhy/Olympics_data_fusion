 ...
 * uses the {@link ClusteredVote} function for weight values to account for unit
 * conversion rounding or different number of decimal places.
 * 
 * @author Tido Felix Marschall
 * 
 */
public class WeightFuserClusteredVote extends AttributeValueFuser<Double, Athlete, Attribute> {

	public WeightFuserClusteredVote() {
		super(new ClusteredVote<Double, Athlete, Attribute>(new AbsoluteDifferenceSimilarity(2.1), 0.00001));
	}
